...
TEST_F(Test_Operator_Division, Integer_Div_Integer_Gives_Integer) {
    st.push(shared_ptr<ComplexLiteral>(new ComplexLiteral(shared_ptr<NumericLiteral>(new NumericLiteral(6.0)))));
...
TEST_F(Test_Operator_Division, Integer_Div_Real_Gives_Real) {
    try {
        st.push(shared_ptr<ComplexLiteral>(new ComplexLiteral(shared_ptr<NumericLiteral>(new NumericLiteral(3.0)))));
        st.push(shared_ptr<ComplexLiteral>(new ComplexLiteral(shared_ptr<NumericLiteral>(new NumericLiteral(0.8)))));
        op_div.execute(&st);
        EXPECT_EQ(1, st.size());
...
TEST_F(Test_Operator_Division, Real_Div_Rational_Gives_Real) {
    st.push(shared_ptr<ComplexLiteral>(new ComplexLiteral(shared_ptr<NumericLiteral>(new NumericLiteral(1.7)))));
...
TEST_F(Test_Operator_Division, Real_Div_Real_Gives_Real) {
    st.push(shared_ptr<ComplexLiteral>(new ComplexLiteral(shared_ptr<NumericLiteral>(new NumericLiteral(0.55)))));
    st.push(shared_ptr<ComplexLiteral>(new ComplexLiteral(shared_ptr<NumericLiteral>(new NumericLiteral(0.5)))));
    op_div.execute(&st);
    EXPECT_EQ(1, st.size());
...
TEST_F(Test_Operator_Division, Real_Div_Integer_Gives_Real) {
    st.push(shared_ptr<ComplexLiteral>(new ComplexLiteral(shared_ptr<NumericLiteral>(new NumericLiteral(4.5)))));

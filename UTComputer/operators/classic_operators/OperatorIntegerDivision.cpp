#include "OperatorIntegerDivision.h"
...
shared_ptr<Literal> OperatorIntegerDivision::executeSpecificOperator() {
    try {
        ...
        if (comp_a != nullptr && comp_b != nullptr) {
            if (comp_a->isInteger() && comp_b->isInteger()) {
                ...
                throw UTComputerException("Error in OperatorIntegerDivision::executeSpecificOperator : arguments must be integers.") ;
            }
        }
        ...
        throw UTComputerException("Error in OperatorIntegerDivision::executeSpecificOperator : invalid literal types for both arguments") ;
    }
        ...
        e1.insertBefore("Error in applying OperatorIntegerDivision on ");
        throw e1;
    }
}
// ===============================================================================================================

#include "OperatorSuperiorEqual.h"
 ...
 */
shared_ptr<Literal> OperatorSuperiorEqual::executeSpecificOperator() {
    try {
        ...
        throw UTComputerException("Error in OperatorSuperiorEqual::executeSpecificOperator : invalid literal types") ;
    }
        ...
        e1.insertBefore("Error in applying OperatorSuperiorEqual on ");
        throw e1;
    }

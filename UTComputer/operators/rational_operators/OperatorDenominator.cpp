 ...
 */
shared_ptr<Literal> OperatorDenominator::executeSpecificOperator() {
    try {
        ...
        if (comp_a != nullptr ) {
            ...
            if (comp_a->isRational()) {
                ...
                throw UTComputerException("Error in OperatorDenominator::executeSpecificOperator : argument must be a rational.") ;
            }
        }
        ...
        throw UTComputerException("Error in OperatorDenominator::executeSpecificOperator : invalid literal types") ;
    }
    catch (UTComputerException e) {
        UTComputerException e1(e.getMessage());
        e1.insertBefore(" --> ");
        e1.insertBefore(arguments[0]->toString());
        e1.insertBefore("Error in applying OperatorDenominator on ");
        throw e1;
    }
}
// ===============================================================================================================